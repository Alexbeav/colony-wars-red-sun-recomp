...
[![GitHub downloads (all assets, all releases)](https://img.shields.io/github/downloads/Alexbeav/colony-wars-red-sun-recomp/total)](https://github.com/Alexbeav/colony-wars-red-sun-recomp/releases)
[![GitHub downloads (latest release)](https://img.shields.io/github/downloads/Alexbeav/colony-wars-red-sun-recomp/latest/total)](https://github.com/Alexbeav/colony-wars-red-sun-recomp/releases/latest)
[![GitHub release](https://img.shields.io/github/v/release/Alexbeav/colony-wars-red-sun-recomp)](https://github.com/Alexbeav/colony-wars-red-sun-recomp/releases/latest)
<!-- /retcomm-readme-metrics -->

Static recompilation of **Colony Wars: Red Sun** built on
[psxrecomp](https://github.com/mstan/psxrecomp) and
[recomp-ui](https://github.com/RetroPortingToolKit/recomp-ui).

This is an owned-input setup kit. You supply your own SLUS-00866 disc image
...
|---|---|
| Region | USA |
| Disc serial | SLUS-00866 |
| Discs | 1 |
| Supported dump | Redump `Colony Wars - Red Sun (USA).cue` as CUE/BIN or CHD |
| BIOS | SCPH-1001 (USA), 524288 bytes, SHA-256 `71af94d1e47a68c11e8fdb9f8368040601514a42a5a399cda48c7d3bff1e99d3` |

## Setup

1. Download the setup ZIP for your platform from [Releases](https://github.com/Alexbeav/colony-wars-red-sun-recomp/releases)
   and extract it into a writable folder.
2. Start `Colony_Wars_Red_Sun` (`.exe` on Windows).
...
- Windows play testing on the private build this kit derives from: Playable, with the movies not centered. The accepted movie-centering hook is generated from this kit's own recipe and shipped as a bundled mod.
...
named `diagnostic-mode.txt` next to `Colony_Wars_Red_Sun.exe` and start the game as
usual, or run `Colony_Wars_Red_Sun.exe --diagnostic`. Reproduce the problem, quit, then
run `Colony_Wars_Red_Sun.exe --collect-diagnostics`: it writes `diagnostics-<date>.zip`
