...
static const PsxrecompCodegenHostConfig kCodegenConfig = {
    .display_name = "Colony Wars: Red Sun",
    .project_root_env = "COLONY_WARS_RED_SUN_PROJECT_ROOT",
    .build_dir_env = "COLONY_WARS_RED_SUN_BUILD_DIR",
    .force_setup_env = "COLONY_WARS_RED_SUN_FORCE_SETUP",
    .psxrecomp_cli_relpath = "psxrecomp/psxrecomp_cli.py",
    .seed_cfg_relpath = "game.toml",
    .game_toml_relpath = "game.toml",
    .gen_marker_relpath = "generated/SLUS_008.66_dispatch.c",
    .build_dir_name = "build-release",
    .cmake_target = "psx-runtime",
    .exe_basename = "Colony_Wars_Red_Sun",
    .prepare_note =
